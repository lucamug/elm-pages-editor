...
var _lucamug$elm_pages_editor$Styleguide$attrClose = {
	...
	_1: {
		...
		_1: {
			ctor: '::',
			_0: _mdgriffith$stylish_elephants$Element_Font$mouseOverColor(_elm_lang$core$Color$black),
			_1: {
				ctor: '::',
...
var _lucamug$elm_pages_editor$Styleguide$attrOpen = {
	...
	_1: {
		...
		_1: {
			ctor: '::',
			_0: _mdgriffith$stylish_elephants$Element_Background$mouseOverColor(_elm_lang$core$Color$white),
			_1: {ctor: '[]'}
		}
	}
};
			...
			{ctor: '[]'},
			{
				...
				_0: A2(
					...
					},
					{
						...
						notice: _elm_lang$core$Maybe$Just(
							A2(
...
var _lucamug$elm_pages_editor$Pages_Form$view2 = F2(
	function (viewPort, model) {
		...
		var structure = twoBoxesInAColumn ? _mdgriffith$stylish_elephants$Element$column(
			{
				ctor: '::',
...
var Elm = {};
Elm['Pages'] = Elm['Pages'] || {};
Elm['Pages']['Form'] = Elm['Pages']['Form'] || {};
if (typeof _lucamug$elm_pages_editor$Pages_Form$main !== 'undefined') {
    _lucamug$elm_pages_editor$Pages_Form$main(Elm['Pages']['Form'], 'Pages.Form', undefined);
}
